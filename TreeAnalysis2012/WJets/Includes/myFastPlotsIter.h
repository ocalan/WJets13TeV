...
void FastPlotsRun(const int *sel, int nsel, string leptonFlavor, string variable, string variableStd, bool logZ, bool decrease, int SVDkterm, int Bayeskterm, bool closureTest = 0, int JetPtMin = 30, int JetPtMax = 0, bool doFlat = 0, bool doVarWidth = 1);
