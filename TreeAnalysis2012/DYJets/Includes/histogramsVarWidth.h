...
int nJetPtEta_Zinc1jet(9);
double jetPtEta_Zinc1jet[10] = {20, 30, 40, 52, 68, 88, 113, 144, 184, 480};
int nJetPtEta_Zinc2jet(8);
double jetPtEta_Zinc2jet[9]  = {20, 30, 40, 52, 68, 88, 113, 144, 377};
...
/* old
   ...
   int nJetPt_Zinc4jet(7);
   double jetPt_Zinc4jet[8] =  {20, 24, 30, 40, 52, 68, 88, 113};
   int nJetPt_Zinc5jet(6);
   double jetPt_Zinc5jet[7] =  {20, 24, 30, 40, 52, 68, 88};
   */
// first trial
//int nJetPt_Zinc1jet(27);
//double jetPt_Zinc1jet[28] = {20, 24, 30, 40, 50, 60, 70, 80, 90, 100, 
//                             120, 140, 160, 180, 200, 220, 250, 280, 310, 340, 370, 400,
//                             450, 500, 550, 600, 700, 1000};
// second trial
//int nJetPt_Zinc1jet(27);
//double jetPt_Zinc1jet[28] = {20, 24, 30, 38, 47, 57, 68, 80, 93, 108, 
//                             125, 143, 163, 186, 211, 239, 270, 304, 342, 385, 432, 483,
//                             541, 605, 676, 755, 842, 1000};
// third trial (first 11 bins have less than 60%)
//int nJetPt_Zinc1jet(22);
//double jetPt_Zinc1jet[23] = {30, 36,43, 51, 60, 71, 83, 97, 114, 133, 154, 179, 208, 242, 281, 325, 377, 436, 505, 584, 675, 781, 1100};
// fourth trial

int nJetPt_Zinc1jet(24);
double jetPt_Zinc1jet[25] = {20, 24, 30, 36, 43, 51, 60, 71, 83, 97, 114, 133, 154, 179, 208, 242, 281, 325, 377, 436, 505, 584, 675, 781, 1100};
int nJetPt_Zinc2jet(12);
double jetPt_Zinc2jet[13] = {20, 24, 30, 40, 52, 68, 88, 113, 144, 184, 234, 297, 377};
int nJetPt_Zinc3jet(9);
double jetPt_Zinc3jet[10] = {20, 24, 30, 40, 52, 68, 88, 113, 144, 184};
...
TH1D *NumberPFcandidates                     = newHisto("NumberPFcandidates",                     "NumberPFcandidates",                             "Number of lepton PF candidates",    20, -0.5, 19.5);

//TH1D *ZMass_lowDeltaR                     = newHisto("ZMass_lowDeltaR",                     "ZMass_lowDeltaR",                             Mll,    120, 50, 169);

TH1D *ZMass_Zinc0jet_test                 = newHisto("ZMass_Zinc0jet_test",                 "Z Invariant Mass (N_{jets} #geq 0)",          Mll,    111, 50, 260 );
TH1D *ZMass_Zinc0jet                      = newHisto("ZMass_Zinc0jet",                      "Z Invariant Mass (N_{jets} #geq 0)",          Mll,    111, 50, 260 );
TH1D *ZMass_Zinc1jet                      = newHisto("ZMass_Zinc1jet",                      "Z Invariant Mass (N_{jets} #geq 1)",          Mll,    111, 50, 260 );
TH1D *ZMass_Zinc2jet                      = newHisto("ZMass_Zinc2jet",                      "Z Invariant Mass (N_{jets} #geq 2)",          Mll,    111, 50, 260 );
TH1D *ZMass_Zinc3jet                      = newHisto("ZMass_Zinc3jet",                      "Z Invariant Mass (N_{jets} #geq 3)",          Mll,    111, 50, 260 );
TH1D *ZMass_Zinc4jet                      = newHisto("ZMass_Zinc4jet",                      "Z Invariant Mass (N_{jets} #geq 4)",          Mll,    111, 50, 260 );
TH1D *ZMass_Zinc5jet                      = newHisto("ZMass_Zinc5jet",                      "Z Invariant Mass (N_{jets} #geq 5)",          Mll,    111, 50, 260 );
TH1D *ZMass_Zinc6jet                      = newHisto("ZMass_Zinc6jet",                      "Z Invariant Mass (N_{jets} #geq 6)",          Mll,    111, 50, 260 );

TH1D *genZMass_Zinc0jet_test              = newHisto("genZMass_Zinc0jet_test",              "Z Invariant Mass (N_{jets} #geq 0)",          Mll,    111, 50, 260 );
TH1D *genZMass_Zinc0jet                   = newHisto("genZMass_Zinc0jet",                   "Z Invariant Mass (N_{jets} #geq 0)",          Mll,    111, 50, 260 );
TH1D *genZMass_Zinc1jet                   = newHisto("genZMass_Zinc1jet",                   "Z Invariant Mass (N_{jets} #geq 1)",          Mll,    111, 50, 260 );
TH1D *genZMass_Zinc2jet                   = newHisto("genZMass_Zinc2jet",                   "Z Invariant Mass (N_{jets} #geq 2)",          Mll,    111, 50, 260 );
TH1D *genZMass_Zinc3jet                   = newHisto("genZMass_Zinc3jet",                   "Z Invariant Mass (N_{jets} #geq 3)",          Mll,    111, 50, 260 );
TH1D *genZMass_Zinc4jet                   = newHisto("genZMass_Zinc4jet",                   "Z Invariant Mass (N_{jets} #geq 4)",          Mll,    111, 50, 260 );
TH1D *genZMass_Zinc5jet                   = newHisto("genZMass_Zinc5jet",                   "Z Invariant Mass (N_{jets} #geq 5)",          Mll,    111, 50, 260 );
TH1D *genZMass_Zinc6jet                   = newHisto("genZMass_Zinc6jet",                   "Z Invariant Mass (N_{jets} #geq 6)",          Mll,    111, 50, 260 );

TH1D *ZMass_Zexc0jet                      = newHisto("ZMass_Zexc0jet",                      "Z Invariant Mass (N_{jets} = 0)",             Mll,    111, 50, 260 );
TH1D *ZMass_Zexc1jet                      = newHisto("ZMass_Zexc1jet",                      "Z Invariant Mass (N_{jets} = 1)",             Mll,    111, 50, 260 );
TH1D *ZMass_Zexc2jet                      = newHisto("ZMass_Zexc2jet",                      "Z Invariant Mass (N_{jets} = 2)",             Mll,    111, 50, 260 );
TH1D *ZMass_Zexc3jet                      = newHisto("ZMass_Zexc3jet",                      "Z Invariant Mass (N_{jets} = 3)",             Mll,    111, 50, 260 );
TH1D *ZMass_Zexc4jet                      = newHisto("ZMass_Zexc4jet",                      "Z Invariant Mass (N_{jets} = 4)",             Mll,    111, 50, 260 );
TH1D *ZMass_Zexc5jet                      = newHisto("ZMass_Zexc5jet",                      "Z Invariant Mass (N_{jets} = 5)",             Mll,    111, 50, 260 );
TH1D *ZMass_Zexc6jet                      = newHisto("ZMass_Zexc6jet",                      "Z Invariant Mass (N_{jets} = 6)",             Mll,    111, 50, 260 );
...
TH1D *lepPhi_Zinc0jet                     = newHisto("lepPhi_Zinc0jet",                     "1st & 2nd lep #phi (N_{jets} #geq 0)",           lphi,   24,-PI, PI);
TH1D *lepPhi_Zinc1jet                     = newHisto("lepPhi_Zinc1jet",                     "1st & 2nd lep #phi (N_{jets} #geq 1)",           lphi,   24,-PI, PI);
...
/*
   TH1D *lepPhi_Zexc0jet                     = newHisto("lepPhi_Zexc0jet",                     "1st & 2nd lep #phi (N_{jets} = 0)",           lphi,   24,-PI, PI);
   TH1D *lepPhi_Zexc1jet                     = newHisto("lepPhi_Zexc1jet",                     "1st & 2nd lep #phi (N_{jets} = 1)",           lphi,   24,-PI, PI);
   TH1D *lepPhi_Zexc2jet                     = newHisto("lepPhi_Zexc2jet",                     "1st & 2nd lep #phi (N_{jets} = 2)",           lphi,   24,-PI, PI);
   TH1D *lepPhi_Zexc3jet                     = newHisto("lepPhi_Zexc3jet",                     "1st & 2nd lep #phi (N_{jets} = 3)",           lphi,   24,-PI, PI);
   TH1D *lepPhi_Zexc4jet                     = newHisto("lepPhi_Zexc4jet",                     "1st & 2nd lep #phi (N_{jets} = 4)",           lphi,   24,-PI, PI);
   TH1D *lepPhi_Zexc5jet                     = newHisto("lepPhi_Zexc5jet",                     "1st & 2nd lep #phi (N_{jets} = 5)",           lphi,   24,-PI, PI);
   */

TH2D *lepEtaEta_Zinc0jet                  = new TH2D("lepEtaEta_Zinc0jet",                  "#eta #eta (N_{jets} #geq 0)",                  12, -2.4, 2.4, 12,-2.4, 2.4);

TH1D *FirstJetEta_Zinc1jet                = newHisto("FirstJetEta_Zinc1jet",                "1st jet #eta (N_{jets} #geq 1)",              "#eta(j_{1})",  47,-4.7, 4.7);  
TH1D *SecondJetEta_Zinc2jet               = newHisto("SecondJetEta_Zinc2jet",               "2nd jet #eta (N_{jets} #geq 2)",              "#eta(j_{2})",  47,-4.7, 4.7);  
TH1D *ThirdJetEta_Zinc3jet                = newHisto("ThirdJetEta_Zinc3jet",                "3rd jet #eta (N_{jets} #geq 3)",              "#eta(j_{3})",  16,-4.8, 4.8);  
TH1D *FourthJetEta_Zinc4jet               = newHisto("FourthJetEta_Zinc4jet",               "4th jet #eta (N_{jets} #geq 4)",              "#eta(j_{4})",   8,-2.4, 2.4);  
TH1D *FifthJetEta_Zinc5jet                = newHisto("FifthJetEta_Zinc5jet",                "5th jet #eta (N_{jets} #geq 5)",              "#eta(j_{5})",   4,-2.4, 2.4);  
TH1D *SixthJetEta_Zinc6jet                = newHisto("SixthJetEta_Zinc6jet",                "#geq 6th jets #eta (N_{jets} #geq 6)",        "#eta(j_{6})",   4,-2.4, 2.4);  

TH1D *genFirstJetEta_Zinc1jet             = newHisto("genFirstJetEta_Zinc1jet",             "gen 1st jet #eta (N_{jets} #geq 1)",          "#eta(j_{1})",  47,-4.7, 4.7);
TH1D *genSecondJetEta_Zinc2jet            = newHisto("genSecondJetEta_Zinc2jet",            "gen 2nd jet #eta (N_{jets} #geq 2)",          "#eta(j_{2})",  47,-4.7, 4.7);
TH1D *genThirdJetEta_Zinc3jet             = newHisto("genThirdJetEta_Zinc3jet",             "gen 3rd jet #eta (N_{jets} #geq 3)",          "#eta(j_{3})",  16,-4.8, 4.8);
TH1D *genFourthJetEta_Zinc4jet            = newHisto("genFourthJetEta_Zinc4jet",            "gen 4th jet #eta (N_{jets} #geq 4)",          "#eta(j_{4})",   8,-2.4, 2.4);
TH1D *genFifthJetEta_Zinc5jet             = newHisto("genFifthJetEta_Zinc5jet",             "gen 5th jet #eta (N_{jets} #geq 5)",          "#eta(j_{5})",   4,-2.4, 2.4);
TH1D *genSixthJetEta_Zinc6jet             = newHisto("genSixthJetEta_Zinc6jet",             "gen #geq 6th jets #eta (N_{jets} #geq 6)",    "#eta(j_{6})",   4,-2.4, 2.4);


TH1D *FirstJetEta_Zexc1jet                = newHisto("FirstJetEta_Zexc1jet",                "1st jet #eta (N_{jets} = 1)",                 "#eta(j_{1})",  47,-4.7, 4.7);  
TH1D *SecondJetEta_Zexc2jet               = newHisto("SecondJetEta_Zexc2jet",               "2nd jet #eta (N_{jets} = 2)",                 "#eta(j_{2})",  47,-4.7, 4.7);  

TH1D *AllJetEta_Zinc1jet                  = newHisto("AllJetEta_Zinc1jet",                  "All jets #eta (N_{jets} #geq 1)",             "#eta(jets)",   47,-4.7, 4.7);  
TH1D *AllJetEta_Zinc2jet                  = newHisto("AllJetEta_Zinc2jet",                  "All jets #eta (N_{jets} #geq 2)",             "#eta(jets)",   47,-4.7, 4.7);  
TH1D *AllJetEta_Zinc3jet                  = newHisto("AllJetEta_Zinc3jet",                  "All jets #eta (N_{jets} #geq 3)",             "#eta(jets)",   47,-4.7, 4.7);  
TH1D *AllJetEta_Zinc4jet                  = newHisto("AllJetEta_Zinc4jet",                  "All jets #eta (N_{jets} #geq 4)",             "#eta(jets)",   47,-4.7, 4.7);  

TH1D *FirstJetPhi_Zinc1jet                = newHisto("FirstJetPhi_Zinc1jet",                "1st jet #phi (N_{jets} #geq 1)",              "#phi(j_{1})",  30,-PI, PI );
TH1D *SecondJetPhi_Zinc2jet               = newHisto("SecondJetPhi_Zinc2jet",               "2nd jet #phi (N_{jets} #geq 2)",              "#phi(j_{2})",  30,-PI, PI );
TH1D *ThirdJetPhi_Zinc3jet                = newHisto("ThirdJetPhi_Zinc3jet",                "3rd jet #phi (N_{jets} #geq 3)",              "#phi(j_{3})",  30,-PI, PI );
TH1D *FourthJetPhi_Zinc4jet               = newHisto("FourthJetPhi_Zinc4jet",               "4th jet #phi (N_{jets} #geq 4)",              "#phi(j_{4})",  30,-PI, PI );
TH1D *FifthJetPhi_Zinc5jet                = newHisto("FifthJetPhi_Zinc5jet",                "5th jet #phi (N_{jets} #geq 5)",              "#phi(j_{5})",  30,-PI, PI );
TH1D *SixthJetPhi_Zinc6jet                = newHisto("SixthJetPhi_Zinc6jet",                "6th jet #phi (N_{jets} #geq 6)",              "#phi(j_{6})",  30,-PI, PI );

TH1D *FirstJetPhi_Zexc1jet                = newHisto("FirstJetPhi_Zexc1jet",                "1st jet #phi (N_{jets} = 1)",                 "#phi(j_{1})",  30,-PI, PI );
TH1D *SecondJetPhi_Zexc2jet               = newHisto("SecondJetPhi_Zexc2jet",               "2nd jet #phi (N_{jets} = 2)",                 "#phi(j_{2})",  30,-PI, PI );

TH1D *AllJetPhi_Zinc1jet                  = newHisto("AllJetPhi_Zinc1jet",                  "All jets #phi (N_{jets} #geq 1)",             "#phi(jets)",   30,-PI, PI );
TH1D *AllJetPhi_Zinc2jet                  = newHisto("AllJetPhi_Zinc2jet",                  "All jets #phi (N_{jets} #geq 2)",             "#phi(jets)",   30,-PI, PI );
TH1D *AllJetPhi_Zinc3jet                  = newHisto("AllJetPhi_Zinc3jet",                  "All jets #phi (N_{jets} #geq 3)",             "#phi(jets)",   30,-PI, PI );
TH1D *AllJetPhi_Zinc4jet                  = newHisto("AllJetPhi_Zinc4jet",                  "All jets #phi (N_{jets} #geq 4)",             "#phi(jets)",   30,-PI, PI );
...
TH1D *JetsHT_Zinc1jet                     = newHisto("JetsHT_Zinc1jet",                     "Scalar sum jets p_{T} (N_{jets} #geq 1)",     HT,     nJetHT_Zinc1jet, jetHT_Zinc1jet);  
TH1D *JetsHT_Zinc2jet                     = newHisto("JetsHT_Zinc2jet",                     "Scalar sum jets p_{T} (N_{jets} #geq 2)",     HT,     nJetHT_Zinc2jet, jetHT_Zinc2jet);  
TH1D *JetsHT_Zinc3jet                     = newHisto("JetsHT_Zinc3jet",                     "Scalar sum jets p_{T} (N_{jets} #geq 3)",     HT,     nJetHT_Zinc3jet, jetHT_Zinc3jet);  
TH1D *JetsHT_Zinc4jet                     = newHisto("JetsHT_Zinc4jet",                     "Scalar sum jets p_{T} (N_{jets} #geq 4)",     HT,     nJetHT_Zinc4jet, jetHT_Zinc4jet);  
TH1D *JetsHT_Zinc5jet                     = newHisto("JetsHT_Zinc5jet",                     "Scalar sum jets p_{T} (N_{jets} #geq 5)",     HT,     nJetHT_Zinc5jet, jetHT_Zinc5jet);  
TH1D *JetsHT_Zinc6jet                     = newHisto("JetsHT_Zinc6jet",                     "Scalar sum jets p_{T} (N_{jets} #geq 6)",     HT,     nJetHT_Zinc5jet, jetHT_Zinc5jet);  

TH1D *genJetsHT_Zinc1jet                  = newHisto("genJetsHT_Zinc1jet",                  "Scalar sum jets p_{T} (N_{jets} #geq 1)",     HT,     nJetHT_Zinc1jet, jetHT_Zinc1jet);  
TH1D *genJetsHT_Zinc2jet                  = newHisto("genJetsHT_Zinc2jet",                  "Scalar sum jets p_{T} (N_{jets} #geq 2)",     HT,     nJetHT_Zinc2jet, jetHT_Zinc2jet);  
TH1D *genJetsHT_Zinc3jet                  = newHisto("genJetsHT_Zinc3jet",                  "Scalar sum jets p_{T} (N_{jets} #geq 3)",     HT,     nJetHT_Zinc3jet, jetHT_Zinc3jet);  
TH1D *genJetsHT_Zinc4jet                  = newHisto("genJetsHT_Zinc4jet",                  "Scalar sum jets p_{T} (N_{jets} #geq 4)",     HT,     nJetHT_Zinc4jet, jetHT_Zinc4jet);  
TH1D *genJetsHT_Zinc5jet                  = newHisto("genJetsHT_Zinc5jet",                  "Scalar sum jets p_{T} (N_{jets} #geq 5)",     HT,     nJetHT_Zinc5jet, jetHT_Zinc5jet);  
TH1D *genJetsHT_Zinc6jet                  = newHisto("genJetsHT_Zinc6jet",                  "Scalar sum jets p_{T} (N_{jets} #geq 6)",     HT,     nJetHT_Zinc5jet, jetHT_Zinc5jet);  

TH1D *FirstJetPt_Zinc1jet                 = newHisto("FirstJetPt_Zinc1jet",                 "1st jet p_{T} (N_{jets} #geq 1)",             "p_{T}(j_{1}) [GeV]",     nJetPt_Zinc1jet, jetPt_Zinc1jet); 
TH1D *SecondJetPt_Zinc2jet                = newHisto("SecondJetPt_Zinc2jet",                "2nd jet p_{T} (N_{jets} #geq 2)",             "p_{T}(j_{2}) [GeV]",     nJetPt_Zinc2jet, jetPt_Zinc2jet); 
TH1D *ThirdJetPt_Zinc3jet                 = newHisto("ThirdJetPt_Zinc3jet",                 "3rd jet p_{T} (N_{jets} #geq 3)",             "p_{T}(j_{3}) [GeV]",     nJetPt_Zinc3jet, jetPt_Zinc3jet); 
TH1D *FourthJetPt_Zinc4jet                = newHisto("FourthJetPt_Zinc4jet",                "4th jet p_{T} (N_{jets} #geq 4)",             "p_{T}(j_{4}) [GeV]",     nJetPt_Zinc4jet, jetPt_Zinc4jet); 
TH1D *FifthJetPt_Zinc5jet                 = newHisto("FifthJetPt_Zinc5jet",                 "5th jet p_{T} (N_{jets} #geq 5)",             "p_{T}(j_{5}) [GeV]",     nJetPt_Zinc5jet, jetPt_Zinc5jet); 
TH1D *SixthJetPt_Zinc6jet                 = newHisto("SixthJetPt_Zinc6jet",                 "#geq 6th jets p_{T} (N_{jets} #geq 6)",       "p_{T}(j_{6}) [GeV]",     nJetPt_Zinc5jet, jetPt_Zinc5jet); 
TH1D *RatioJetPt21_Zinc2jet              = newHisto("RatioJetPt21_Zinc2jet",                "ratio 2nd/1st jet p_{T} (N_{jets} #geq 2)",         "p_{T}(j_{2})/p_{T}(j_{1})",    10 , 0 , 1);
TH1D *RatioJetPt32_Zinc3jet              = newHisto("RatioJetPt32_Zinc3jet",                "ratio 3rd/2nd jet p_{T} (N_{jets} #geq 3)",         "p_{T}(j_{3})/p_{T}(j_{2})",    10 , 0 , 1);



TH1D *genFirstJetPt_Zinc1jet              = newHisto("genFirstJetPt_Zinc1jet",              "gen 1st jet p_{T} (N_{jets} #geq 1)",         "p_{T}(j_{1}) [GeV]",     nJetPt_Zinc1jet, jetPt_Zinc1jet);
TH1D *genSecondJetPt_Zinc2jet             = newHisto("genSecondJetPt_Zinc2jet",             "gen 2nd jet p_{T} (N_{jets} #geq 2)",         "p_{T}(j_{2}) [GeV]",     nJetPt_Zinc2jet, jetPt_Zinc2jet);
TH1D *genThirdJetPt_Zinc3jet              = newHisto("genThirdJetPt_Zinc3jet",              "gen 3rd jet p_{T} (N_{jets} #geq 3)",         "p_{T}(j_{3}) [GeV]",     nJetPt_Zinc3jet, jetPt_Zinc3jet);
TH1D *genFourthJetPt_Zinc4jet             = newHisto("genFourthJetPt_Zinc4jet",             "gen 4th jet p_{T} (N_{jets} #geq 4)",         "p_{T}(j_{4}) [GeV]",     nJetPt_Zinc4jet, jetPt_Zinc4jet);
TH1D *genFifthJetPt_Zinc5jet              = newHisto("genFifthJetPt_Zinc5jet",              "gen 5th jet p_{T} (N_{jets} #geq 5)",         "p_{T}(j_{5}) [GeV]",     nJetPt_Zinc5jet, jetPt_Zinc5jet);
TH1D *genSixthJetPt_Zinc6jet              = newHisto("genSixthJetPt_Zinc6jet",              "gen #geq 6th jets p_{T} (N_{jets} #geq 6)",   "p_{T}(j_{6}) [GeV]",     nJetPt_Zinc5jet, jetPt_Zinc5jet);
TH1D *genRatioJetPt21_Zinc2jet              = newHisto("genRatioJetPt21_Zinc2jet",           "gen ratio 2nd/1st jet p_{T} (N_{jets} #geq 2)",         "p_{T}(j_{2})/p_{T}(j_{1})",    10 , 0 , 1);
TH1D *genRatioJetPt32_Zinc3jet              = newHisto("genRatioJetPt32_Zinc3jet",           "gen ratio 3rd/2nd jet p_{T} (N_{jets} #geq 3)",         "p_{T}(j_{3})/p_{T}(j_{2})",    10 , 0 , 1);


TH1D *FirstJetPt_Zinc1jet_test            = newHisto("FirstJetPt_Zinc1jet_test",            "1st jet p_{T} (N_{jets} #geq 1)",             "p_{T}(j_{1}) [GeV]",     nJetPt_Zinc1jet, jetPt_Zinc1jet);
TH1D *SecondJetPt_Zinc2jet_test           = newHisto("SecondJetPt_Zinc2jet_test",           "2nd jet p_{T} (N_{jets} #geq 2)",             "p_{T}(j_{2}) [GeV]",     nJetPt_Zinc2jet, jetPt_Zinc2jet);
TH1D *ThirdJetPt_Zinc3jet_test            = newHisto("ThirdJetPt_Zinc3jet_test",            "3rd jet p_{T} (N_{jets} #geq 3)",             "p_{T}(j_{3}) [GeV]",     nJetPt_Zinc3jet, jetPt_Zinc3jet);
TH1D *FourthJetPt_Zinc4jet_test           = newHisto("FourthJetPt_Zinc4jet_test",           "4th jet p_{T} (N_{jets} #geq 4)",             "p_{T}(j_{4}) [GeV]",     nJetPt_Zinc4jet, jetPt_Zinc4jet);
TH1D *FifthJetPt_Zinc5jet_test            = newHisto("FifthJetPt_Zinc5jet_test",            "5th jet p_{T} (N_{jets} #geq 5)",             "p_{T}(j_{5}) [GeV]",     nJetPt_Zinc5jet, jetPt_Zinc5jet);
TH1D *SixthJetPt_Zinc6jet_test            = newHisto("SixthJetPt_Zinc6jet_test",            "#geq 6th jets p_{T} (N_{jets} #geq 6)",       "p_{T}(j_{6}) [GeV]",     nJetPt_Zinc5jet, jetPt_Zinc5jet);

TH1D *genFirstJetPt_Zinc1jet_test         = newHisto("genFirstJetPt_Zinc1jet_test",         "gen 1st jet p_{T} (N_{jets} #geq 1)",         "p_{T}(j_{1}) [GeV]",     nJetPt_Zinc1jet, jetPt_Zinc1jet);
TH1D *genSecondJetPt_Zinc2jet_test        = newHisto("genSecondJetPt_Zinc2jet_test",        "gen 2nd jet p_{T} (N_{jets} #geq 2)",         "p_{T}(j_{2}) [GeV]",     nJetPt_Zinc2jet, jetPt_Zinc2jet);
TH1D *genThirdJetPt_Zinc3jet_test         = newHisto("genThirdJetPt_Zinc3jet_test",         "gen 3rd jet p_{T} (N_{jets} #geq 3)",         "p_{T}(j_{3}) [GeV]",     nJetPt_Zinc3jet, jetPt_Zinc3jet);
TH1D *genFourthJetPt_Zinc4jet_test        = newHisto("genFourthJetPt_Zinc4jet_test",        "gen 4th jet p_{T} (N_{jets} #geq 4)",         "p_{T}(j_{4}) [GeV]",     nJetPt_Zinc4jet, jetPt_Zinc4jet);
TH1D *genFifthJetPt_Zinc5jet_test         = newHisto("genFifthJetPt_Zinc5jet_test",         "gen 5th jet p_{T} (N_{jets} #geq 5)",         "p_{T}(j_{5}) [GeV]",     nJetPt_Zinc5jet, jetPt_Zinc5jet);
TH1D *genSixthJetPt_Zinc6jet_test         = newHisto("genSixthJetPt_Zinc6jet_test",         "gen #geq 6th jets p_{T} (N_{jets} #geq 6)",   "p_{T}(j_{6}) [GeV]",     nJetPt_Zinc5jet, jetPt_Zinc5jet);
TH1D *genRatioJetPt21_Zinc2jet_test              = newHisto("genRatioJetPt21_Zinc2jet_test",           "gen ratio 2nd/1st jet p_{T} (N_{jets} #geq 2)",         "p_{T}(j_{2}/p_{T}(j_{1})",    20 , 0 , 1);
TH1D *genRatioJetPt32_Zinc3jet_test              = newHisto("genRatioJetPt32_Zinc3jet_test",           "gen ratio 3rd/2nd jet p_{T} (N_{jets} #geq 3)",         "p_{T}(j_{3}/p_{T}(j_{2}",    20 , 0 , 1);




TH1D *FirstJetPt_Zexc1jet                 = newHisto("FirstJetPt_Zexc1jet",                 "1st jet p_{T} (N_{jets} = 1)",                "p_{T}(j_{1}) [GeV]",     nJetPt_Zinc1jet, jetPt_Zinc1jet); 
TH1D *SecondJetPt_Zexc2jet                = newHisto("SecondJetPt_Zexc2jet",                "2nd jet p_{T} (N_{jets} = 2)",                "p_{T}(j_{2}) [GeV]",     nJetPt_Zinc2jet, jetPt_Zinc2jet); 

TH1D *genFirstJetPt_Zexc1jet              = newHisto("genFirstJetPt_Zexc1jet",              "gen 1st jet p_{T} (N_{jets} = 1)",            "p_{T}(j_{1}) [GeV]",     nJetPt_Zinc1jet, jetPt_Zinc1jet);
TH1D *genSecondJetPt_Zexc2jet             = newHisto("genSecondJetPt_Zexc2jet",             "gen 2nd jet p_{T} (N_{jets} = 2)",            "p_{T}(j_{2}) [GeV]",     nJetPt_Zinc2jet, jetPt_Zinc2jet);


TH1D *FirstHighestJetPt_Zinc1jet          = newHisto("FirstHighestJetPt_Zinc1jet",          "1st Highest jet p_{T} (N_{jets} #geq 1)",     "p_{T}(j_{1}) [GeV]",     nJetPt_Zinc1jet, jetPt_Zinc1jet); 
TH1D *FirstHighestJetPt_Zinc2jet          = newHisto("FirstHighestJetPt_Zinc2jet",          "1st Highest jet p_{T} (N_{jets} #geq 2)",     "p_{T}(j_{1}) [GeV]",     nJetPt_Zinc2jet, jetPt_Zinc2jet); 
TH1D *FirstHighestJetPt_Zinc3jet          = newHisto("FirstHighestJetPt_Zinc3jet",          "1st Highest jet p_{T} (N_{jets} #geq 3)",     "p_{T}(j_{1}) [GeV]",     nJetPt_Zinc3jet, jetPt_Zinc3jet); 
TH1D *FirstHighestJetPt_Zinc4jet          = newHisto("FirstHighestJetPt_Zinc4jet",          "1st Highest jet p_{T} (N_{jets} #geq 4)",     "p_{T}(j_{1}) [GeV]",     nJetPt_Zinc4jet, jetPt_Zinc4jet); 
TH1D *FirstHighestJetPt_Zinc5jet          = newHisto("FirstHighestJetPt_Zinc5jet",          "1st Highest jet p_{T} (N_{jets} #geq 5)",     "p_{T}(j_{1}) [GeV]",     nJetPt_Zinc5jet, jetPt_Zinc5jet); 
TH1D *FirstHighestJetPt_Zinc6jet          = newHisto("FirstHighestJetPt_Zinc6jet",          "1st Highest jet p_{T} (N_{jets} #geq 6)",     "p_{T}(j_{1}) [GeV]",     nJetPt_Zinc5jet, jetPt_Zinc5jet); 

TH1D *genFirstHighestJetPt_Zinc1jet       = newHisto("genFirstHighestJetPt_Zinc1jet",       "gen 1st Highest jet p_{T} (N_{jets} #geq 1)", "p_{T}(j_{1}) [GeV]",     nJetPt_Zinc1jet, jetPt_Zinc1jet);  
TH1D *genFirstHighestJetPt_Zinc2jet       = newHisto("genFirstHighestJetPt_Zinc2jet",       "gen 1st Highest jet p_{T} (N_{jets} #geq 2)", "p_{T}(j_{1}) [GeV]",     nJetPt_Zinc2jet, jetPt_Zinc2jet);  
TH1D *genFirstHighestJetPt_Zinc3jet       = newHisto("genFirstHighestJetPt_Zinc3jet",       "gen 1st Highest jet p_{T} (N_{jets} #geq 3)", "p_{T}(j_{1}) [GeV]",     nJetPt_Zinc3jet, jetPt_Zinc3jet);  
TH1D *genFirstHighestJetPt_Zinc4jet       = newHisto("genFirstHighestJetPt_Zinc4jet",       "gen 1st Highest jet p_{T} (N_{jets} #geq 4)", "p_{T}(j_{1}) [GeV]",     nJetPt_Zinc4jet, jetPt_Zinc4jet);  
TH1D *genFirstHighestJetPt_Zinc5jet       = newHisto("genFirstHighestJetPt_Zinc5jet",       "gen 1st Highest jet p_{T} (N_{jets} #geq 5)", "p_{T}(j_{1}) [GeV]",     nJetPt_Zinc5jet, jetPt_Zinc5jet);  
TH1D *genFirstHighestJetPt_Zinc6jet       = newHisto("genFirstHighestJetPt_Zinc6jet",       "gen 1st Highest jet p_{T} (N_{jets} #geq 6)", "p_{T}(j_{1}) [GeV]",     nJetPt_Zinc5jet, jetPt_Zinc5jet);  

TH1D *FirstHighestJetPt_Zinc1jet_test     = newHisto("FirstHighestJetPt_Zinc1jet_test",     "1st Highest jet p_{T} (N_{jets} #geq 1)",     "p_{T}(j_{1}) [GeV]",     nJetPt_Zinc1jet, jetPt_Zinc1jet);  
TH1D *FirstHighestJetPt_Zinc2jet_test     = newHisto("FirstHighestJetPt_Zinc2jet_test",     "1st Highest jet p_{T} (N_{jets} #geq 2)",     "p_{T}(j_{1}) [GeV]",     nJetPt_Zinc2jet, jetPt_Zinc2jet); 
TH1D *FirstHighestJetPt_Zinc3jet_test     = newHisto("FirstHighestJetPt_Zinc3jet_test",     "1st Highest jet p_{T} (N_{jets} #geq 3)",     "p_{T}(j_{1}) [GeV]",     nJetPt_Zinc3jet, jetPt_Zinc3jet); 
TH1D *FirstHighestJetPt_Zinc4jet_test     = newHisto("FirstHighestJetPt_Zinc4jet_test",     "1st Highest jet p_{T} (N_{jets} #geq 4)",     "p_{T}(j_{1}) [GeV]",     nJetPt_Zinc4jet, jetPt_Zinc4jet); 
TH1D *FirstHighestJetPt_Zinc5jet_test     = newHisto("FirstHighestJetPt_Zinc5jet_test",     "1st Highest jet p_{T} (N_{jets} #geq 5)",     "p_{T}(j_{1}) [GeV]",     nJetPt_Zinc5jet, jetPt_Zinc5jet); 
TH1D *FirstHighestJetPt_Zinc6jet_test     = newHisto("FirstHighestJetPt_Zinc6jet_test",     "1st Highest jet p_{T} (N_{jets} #geq 6)",     "p_{T}(j_{1}) [GeV]",     nJetPt_Zinc5jet, jetPt_Zinc5jet); 

TH1D *genFirstHighestJetPt_Zinc1jet_test  = newHisto("genFirstHighestJetPt_Zinc1jet_test",  "gen 1st Highest jet p_{T} (N_{jets} #geq 1)", "p_{T}(j_{1}) [GeV]",     nJetPt_Zinc1jet, jetPt_Zinc1jet); 
TH1D *genFirstHighestJetPt_Zinc2jet_test  = newHisto("genFirstHighestJetPt_Zinc2jet_test",  "gen 1st Highest jet p_{T} (N_{jets} #geq 2)", "p_{T}(j_{1}) [GeV]",     nJetPt_Zinc2jet, jetPt_Zinc2jet); 
TH1D *genFirstHighestJetPt_Zinc3jet_test  = newHisto("genFirstHighestJetPt_Zinc3jet_test",  "gen 1st Highest jet p_{T} (N_{jets} #geq 3)", "p_{T}(j_{1}) [GeV]",     nJetPt_Zinc3jet, jetPt_Zinc3jet); 
TH1D *genFirstHighestJetPt_Zinc4jet_test  = newHisto("genFirstHighestJetPt_Zinc4jet_test",  "gen 1st Highest jet p_{T} (N_{jets} #geq 4)", "p_{T}(j_{1}) [GeV]",     nJetPt_Zinc4jet, jetPt_Zinc4jet); 
TH1D *genFirstHighestJetPt_Zinc5jet_test  = newHisto("genFirstHighestJetPt_Zinc5jet_test",  "gen 1st Highest jet p_{T} (N_{jets} #geq 5)", "p_{T}(j_{1}) [GeV]",     nJetPt_Zinc5jet, jetPt_Zinc5jet); 
TH1D *genFirstHighestJetPt_Zinc6jet_test  = newHisto("genFirstHighestJetPt_Zinc6jet_test",  "gen 1st Highest jet p_{T} (N_{jets} #geq 6)", "p_{T}(j_{1}) [GeV]",     nJetPt_Zinc5jet, jetPt_Zinc5jet); 

TH1D *SecondHighestJetPt_Zinc2jet         = newHisto("SecondHighestJetPt_Zinc2jet",         "2nd Highest jet p_{T} (N_{jets} #geq 2)",     "p_{T}(j_{2}) [GeV]",     nJetPt_Zinc2jet, jetPt_Zinc2jet); 
TH1D *SecondHighestJetPt_Zinc3jet         = newHisto("SecondHighestJetPt_Zinc3jet",         "2nd Highest jet p_{T} (N_{jets} #geq 3)",     "p_{T}(j_{2}) [GeV]",     nJetPt_Zinc3jet, jetPt_Zinc3jet); 
TH1D *SecondHighestJetPt_Zinc4jet         = newHisto("SecondHighestJetPt_Zinc4jet",         "2nd Highest jet p_{T} (N_{jets} #geq 4)",     "p_{T}(j_{2}) [GeV]",     nJetPt_Zinc4jet, jetPt_Zinc4jet); 
TH1D *SecondHighestJetPt_Zinc5jet         = newHisto("SecondHighestJetPt_Zinc5jet",         "2nd Highest jet p_{T} (N_{jets} #geq 5)",     "p_{T}(j_{2}) [GeV]",     nJetPt_Zinc5jet, jetPt_Zinc5jet); 
TH1D *SecondHighestJetPt_Zinc6jet         = newHisto("SecondHighestJetPt_Zinc6jet",         "2nd Highest jet p_{T} (N_{jets} #geq 6)",     "p_{T}(j_{2}) [GeV]",     nJetPt_Zinc5jet, jetPt_Zinc5jet); 

TH1D *genSecondHighestJetPt_Zinc2jet      = newHisto("genSecondHighestJetPt_Zinc2jet",      "gen 2nd Highest jet p_{T} (N_{jets} #geq 2)", "p_{T}(j_{2}) [GeV]",     nJetPt_Zinc2jet, jetPt_Zinc2jet); 
TH1D *genSecondHighestJetPt_Zinc3jet      = newHisto("genSecondHighestJetPt_Zinc3jet",      "gen 2nd Highest jet p_{T} (N_{jets} #geq 3)", "p_{T}(j_{2}) [GeV]",     nJetPt_Zinc3jet, jetPt_Zinc3jet); 
TH1D *genSecondHighestJetPt_Zinc4jet      = newHisto("genSecondHighestJetPt_Zinc4jet",      "gen 2nd Highest jet p_{T} (N_{jets} #geq 4)", "p_{T}(j_{2}) [GeV]",     nJetPt_Zinc4jet, jetPt_Zinc4jet); 
TH1D *genSecondHighestJetPt_Zinc5jet      = newHisto("genSecondHighestJetPt_Zinc5jet",      "gen 2nd Highest jet p_{T} (N_{jets} #geq 5)", "p_{T}(j_{2}) [GeV]",     nJetPt_Zinc5jet, jetPt_Zinc5jet); 
TH1D *genSecondHighestJetPt_Zinc6jet      = newHisto("genSecondHighestJetPt_Zinc6jet",      "gen 2nd Highest jet p_{T} (N_{jets} #geq 6)", "p_{T}(j_{2}) [GeV]",     nJetPt_Zinc5jet, jetPt_Zinc5jet); 

TH1D *SecondHighestJetPt_Zinc2jet_test    = newHisto("SecondHighestJetPt_Zinc2jet_test",    "2nd Highest jet p_{T} (N_{jets} #geq 2)",     "p_{T}(j_{2}) [GeV]",     nJetPt_Zinc2jet, jetPt_Zinc2jet); 
TH1D *SecondHighestJetPt_Zinc3jet_test    = newHisto("SecondHighestJetPt_Zinc3jet_test",    "2nd Highest jet p_{T} (N_{jets} #geq 3)",     "p_{T}(j_{2}) [GeV]",     nJetPt_Zinc3jet, jetPt_Zinc3jet); 
TH1D *SecondHighestJetPt_Zinc4jet_test    = newHisto("SecondHighestJetPt_Zinc4jet_test",    "2nd Highest jet p_{T} (N_{jets} #geq 4)",     "p_{T}(j_{2}) [GeV]",     nJetPt_Zinc4jet, jetPt_Zinc4jet); 
TH1D *SecondHighestJetPt_Zinc5jet_test    = newHisto("SecondHighestJetPt_Zinc5jet_test",    "2nd Highest jet p_{T} (N_{jets} #geq 5)",     "p_{T}(j_{2}) [GeV]",     nJetPt_Zinc5jet, jetPt_Zinc5jet); 
TH1D *SecondHighestJetPt_Zinc6jet_test    = newHisto("SecondHighestJetPt_Zinc6jet_test",    "2nd Highest jet p_{T} (N_{jets} #geq 6)",     "p_{T}(j_{2}) [GeV]",     nJetPt_Zinc5jet, jetPt_Zinc5jet); 

TH1D *genSecondHighestJetPt_Zinc2jet_test = newHisto("genSecondHighestJetPt_Zinc2jet_test", "gen 2nd Highest jet p_{T} (N_{jets} #geq 2)", "p_{T}(j_{2}) [GeV]",     nJetPt_Zinc2jet, jetPt_Zinc2jet); 
TH1D *genSecondHighestJetPt_Zinc3jet_test = newHisto("genSecondHighestJetPt_Zinc3jet_test", "gen 2nd Highest jet p_{T} (N_{jets} #geq 3)", "p_{T}(j_{2}) [GeV]",     nJetPt_Zinc3jet, jetPt_Zinc3jet); 
TH1D *genSecondHighestJetPt_Zinc4jet_test = newHisto("genSecondHighestJetPt_Zinc4jet_test", "gen 2nd Highest jet p_{T} (N_{jets} #geq 4)", "p_{T}(j_{2}) [GeV]",     nJetPt_Zinc4jet, jetPt_Zinc4jet); 
TH1D *genSecondHighestJetPt_Zinc5jet_test = newHisto("genSecondHighestJetPt_Zinc5jet_test", "gen 2nd Highest jet p_{T} (N_{jets} #geq 5)", "p_{T}(j_{2}) [GeV]",     nJetPt_Zinc5jet, jetPt_Zinc5jet); 
TH1D *genSecondHighestJetPt_Zinc6jet_test = newHisto("genSecondHighestJetPt_Zinc6jet_test", "gen 2nd Highest jet p_{T} (N_{jets} #geq 6)", "p_{T}(j_{2}) [GeV]",     nJetPt_Zinc5jet, jetPt_Zinc5jet); 

TH1D *ThirdHighestJetPt_Zinc3jet          = newHisto("ThirdHighestJetPt_Zinc3jet",          "3rd Highest jet p_{T} (N_{jets} #geq 3)",     "p_{T}(j_{3}) [GeV]",     nJetPt_Zinc3jet, jetPt_Zinc3jet);
TH1D *ThirdHighestJetPt_Zinc4jet          = newHisto("ThirdHighestJetPt_Zinc4jet",          "3rd Highest jet p_{T} (N_{jets} #geq 4)",     "p_{T}(j_{3}) [GeV]",     nJetPt_Zinc4jet, jetPt_Zinc4jet);
TH1D *ThirdHighestJetPt_Zinc5jet          = newHisto("ThirdHighestJetPt_Zinc5jet",          "3rd Highest jet p_{T} (N_{jets} #geq 5)",     "p_{T}(j_{3}) [GeV]",     nJetPt_Zinc5jet, jetPt_Zinc5jet);
TH1D *ThirdHighestJetPt_Zinc6jet          = newHisto("ThirdHighestJetPt_Zinc6jet",          "3rd Highest jet p_{T} (N_{jets} #geq 6)",     "p_{T}(j_{3}) [GeV]",     nJetPt_Zinc5jet, jetPt_Zinc5jet);

TH1D *genThirdHighestJetPt_Zinc3jet       = newHisto("genThirdHighestJetPt_Zinc3jet",       "gen 3rd Highest jet p_{T} (N_{jets} #geq 3)", "p_{T}(j_{3}) [GeV]",     nJetPt_Zinc3jet, jetPt_Zinc3jet); 
TH1D *genThirdHighestJetPt_Zinc4jet       = newHisto("genThirdHighestJetPt_Zinc4jet",       "gen 3rd Highest jet p_{T} (N_{jets} #geq 4)", "p_{T}(j_{3}) [GeV]",     nJetPt_Zinc4jet, jetPt_Zinc4jet); 
TH1D *genThirdHighestJetPt_Zinc5jet       = newHisto("genThirdHighestJetPt_Zinc5jet",       "gen 3rd Highest jet p_{T} (N_{jets} #geq 5)", "p_{T}(j_{3}) [GeV]",     nJetPt_Zinc5jet, jetPt_Zinc5jet); 
TH1D *genThirdHighestJetPt_Zinc6jet       = newHisto("genThirdHighestJetPt_Zinc6jet",       "gen 3rd Highest jet p_{T} (N_{jets} #geq 6)", "p_{T}(j_{3}) [GeV]",     nJetPt_Zinc5jet, jetPt_Zinc5jet); 

TH1D *ThirdHighestJetPt_Zinc3jet_test     = newHisto("ThirdHighestJetPt_Zinc3jet_test",     "3rd Highest jet p_{T} (N_{jets} #geq 3)",     "p_{T}(j_{3}) [GeV]",     nJetPt_Zinc3jet, jetPt_Zinc3jet); 
TH1D *ThirdHighestJetPt_Zinc4jet_test     = newHisto("ThirdHighestJetPt_Zinc4jet_test",     "3rd Highest jet p_{T} (N_{jets} #geq 4)",     "p_{T}(j_{3}) [GeV]",     nJetPt_Zinc4jet, jetPt_Zinc4jet); 
TH1D *ThirdHighestJetPt_Zinc5jet_test     = newHisto("ThirdHighestJetPt_Zinc5jet_test",     "3rd Highest jet p_{T} (N_{jets} #geq 5)",     "p_{T}(j_{3}) [GeV]",     nJetPt_Zinc5jet, jetPt_Zinc5jet); 
TH1D *ThirdHighestJetPt_Zinc6jet_test     = newHisto("ThirdHighestJetPt_Zinc6jet_test",     "3rd Highest jet p_{T} (N_{jets} #geq 6)",     "p_{T}(j_{3}) [GeV]",     nJetPt_Zinc5jet, jetPt_Zinc5jet); 

TH1D *genThirdHighestJetPt_Zinc3jet_test  = newHisto("genThirdHighestJetPt_Zinc3jet_test",  "gen 3rd Highest jet p_{T} (N_{jets} #geq 3)", "p_{T}(j_{3}) [GeV]",     nJetPt_Zinc3jet, jetPt_Zinc3jet); 
TH1D *genThirdHighestJetPt_Zinc4jet_test  = newHisto("genThirdHighestJetPt_Zinc4jet_test",  "gen 3rd Highest jet p_{T} (N_{jets} #geq 4)", "p_{T}(j_{3}) [GeV]",     nJetPt_Zinc4jet, jetPt_Zinc4jet); 
TH1D *genThirdHighestJetPt_Zinc5jet_test  = newHisto("genThirdHighestJetPt_Zinc5jet_test",  "gen 3rd Highest jet p_{T} (N_{jets} #geq 5)", "p_{T}(j_{3}) [GeV]",     nJetPt_Zinc5jet, jetPt_Zinc5jet); 
TH1D *genThirdHighestJetPt_Zinc6jet_test  = newHisto("genThirdHighestJetPt_Zinc6jet_test",  "gen 3rd Highest jet p_{T} (N_{jets} #geq 6)", "p_{T}(j_{3}) [GeV]",     nJetPt_Zinc5jet, jetPt_Zinc5jet); 
...
TH2D *hPtEtaBackJet_Zexc1jet              = new TH2D("PtEtaBackJet_Zexc1jet",              "p_{T} #eta (N_{jets} = 1)",       nJetPtEta_Zinc1jet, jetPtEta_Zinc1jet   ,      12  ,  0., 2.4);
TH2D *hPtEtaBackJetMVA_Zexc1jet           = new TH2D("PtEtaBackJetMVA_Zexc1jet",           "p_{T} #eta (N_{jets} = 1)",       nJetPtEta_Zinc1jet, jetPtEta_Zinc1jet   ,      12  ,  0., 2.4);
TH2D *FirstJetPtEta_Zinc1jet              = new TH2D("FirstJetPtEta_Zinc1jet",              "1st jet p_{T} #eta (N_{jets} #geq 1)",       nJetPtEta_Zinc1jet, jetPtEta_Zinc1jet   ,      12  ,  0., 2.4);
TH2D *SecondJetPtEta_Zinc2jet             = new TH2D("SecondJetPtEta_Zinc2jet",             "2nd jet p_{T} #eta (N_{jets} #geq 2)",       nJetPtEta_Zinc2jet, jetPtEta_Zinc2jet   ,       8  ,  0., 2.4);
TH2D *ThirdJetPtEta_Zinc3jet              = new TH2D("ThirdJetPtEta_Zinc3jet",              "3rd jet p_{T} #eta (N_{jets} #geq 3)",       nJetPt_Zinc3jet, jetPt_Zinc3jet	        ,       6  ,  0., 2.4);
TH2D *FourthJetPtEta_Zinc4jet             = new TH2D("FourthJetPtEta_Zinc4jet",             "4th jet p_{T} #eta (N_{jets} #geq 4)",       nJetPt_Zinc4jet, jetPt_Zinc4jet         ,       4  ,  0., 2.4);
TH2D *FifthJetPtEta_Zinc5jet              = new TH2D("FifthJetPtEta_Zinc5jet",              "5th jet p_{T} #eta (N_{jets} #geq 5)",       nJetPt_Zinc5jet, jetPt_Zinc5jet         ,       2  ,  0., 2.4);
TH2D *SixthJetPtEta_Zinc6jet              = new TH2D("SixthJetPtEta_Zinc6jet",              "6th jet p_{T} #eta (N_{jets} #geq 6)",       nJetPt_Zinc5jet, jetPt_Zinc5jet         ,       2  ,  0., 2.4);

TH2D *genFirstJetPtEta_Zinc1jet           = new TH2D("genFirstJetPtEta_Zinc1jet",           "gen 1st jet p_{T} #eta (N_{jets} #geq 1)",    nJetPtEta_Zinc1jet, jetPtEta_Zinc1jet  ,      12  ,  0., 2.4);
TH2D *genSecondJetPtEta_Zinc2jet          = new TH2D("genSecondJetPtEta_Zinc2jet",          "gen 2nd jet p_{T} #eta (N_{jets} #geq 2)",    nJetPtEta_Zinc2jet, jetPtEta_Zinc2jet  ,       8  ,  0., 2.4);
TH2D *genThirdJetPtEta_Zinc3jet           = new TH2D("genThirdJetPtEta_Zinc3jet",           "gen 3rd jet p_{T} #eta (N_{jets} #geq 3)",    nJetPt_Zinc3jet, jetPt_Zinc3jet        ,       6  ,  0., 2.4);
TH2D *genFourthJetPtEta_Zinc4jet          = new TH2D("genFourthJetPtEta_Zinc4jet",          "gen 4th jet p_{T} #eta (N_{jets} #geq 4)",    nJetPt_Zinc4jet, jetPt_Zinc4jet        ,       4  ,  0., 2.4);
TH2D *genFifthJetPtEta_Zinc5jet           = new TH2D("genFifthJetPtEta_Zinc5jet",           "gen 5th jet p_{T} #eta (N_{jets} #geq 5)",    nJetPt_Zinc5jet, jetPt_Zinc5jet        ,       2  ,  0., 2.4);
TH2D *genSixthJetPtEta_Zinc6jet           = new TH2D("genSixthJetPtEta_Zinc6jet",           "gen 6th jet p_{T} #eta (N_{jets} #geq 6)",    nJetPt_Zinc5jet, jetPt_Zinc5jet        ,       2  ,  0., 2.4);

TH1D *ZNGoodJets_Zexc = newHisto("ZNGoodJets_Zexc","Jet Counter (excl.)", "N_{jets}", 11, -0.5, 10.5);
...
ZNGoodJets_Zexc->GetXaxis()->SetBinLabel(9,"N_{jets} = 8");
ZNGoodJets_Zexc->GetXaxis()->SetBinLabel(10,"N_{jets} = 9");
ZNGoodJets_Zexc->GetXaxis()->SetBinLabel(11,"N_{jets} = 10");

TH2D *ZNGoodJetsNVtx_Zexc = new TH2D("ZNGoodJetsNVtx_Zexc","Jet Counter (excl.) vs. NVtx", 11, -0.5, 10.5, 45, 0.5, 45.5);
ZNGoodJetsNVtx_Zexc->GetXaxis()->SetBinLabel(1,"N_{jets} = 0");
ZNGoodJetsNVtx_Zexc->GetXaxis()->SetBinLabel(2,"N_{jets} = 1");
ZNGoodJetsNVtx_Zexc->GetXaxis()->SetBinLabel(3,"N_{jets} = 2");
ZNGoodJetsNVtx_Zexc->GetXaxis()->SetBinLabel(4,"N_{jets} = 3");
ZNGoodJetsNVtx_Zexc->GetXaxis()->SetBinLabel(5,"N_{jets} = 4");
ZNGoodJetsNVtx_Zexc->GetXaxis()->SetBinLabel(6,"N_{jets} = 5");
ZNGoodJetsNVtx_Zexc->GetXaxis()->SetBinLabel(7,"N_{jets} = 6");
ZNGoodJetsNVtx_Zexc->GetXaxis()->SetBinLabel(8,"N_{jets} = 7");
ZNGoodJetsNVtx_Zexc->GetXaxis()->SetBinLabel(9,"N_{jets} = 8");
ZNGoodJetsNVtx_Zexc->GetXaxis()->SetBinLabel(10,"N_{jets} = 9");
ZNGoodJetsNVtx_Zexc->GetXaxis()->SetBinLabel(11,"N_{jets} = 10");

TH1D *ZNGoodJets_Zexc_test = newHisto("ZNGoodJets_Zexc_test","Jet Counter (excl.)", "N_{jets}", 11, -0.5, 10.5);
...
ZNGoodJets_Zexc_test->GetXaxis()->SetBinLabel(9,"N_{jets} = 8");
ZNGoodJets_Zexc_test->GetXaxis()->SetBinLabel(10,"N_{jets} = 9");
ZNGoodJets_Zexc_test->GetXaxis()->SetBinLabel(11,"N_{jets} = 10");

TH1D *ZNGoodJets_Zinc_test = newHisto("ZNGoodJets_Zinc_test","Jet Counter (incl.)", "N_{jets}", 11, -0.5, 10.5);
...
ZNGoodJets_Zinc_test->GetXaxis()->SetBinLabel(9,"N_{jets}  #geq 8");
ZNGoodJets_Zinc_test->GetXaxis()->SetBinLabel(10,"N_{jets} #geq 9");
ZNGoodJets_Zinc_test->GetXaxis()->SetBinLabel(11,"N_{jets} #geq 10");

TH1D *ZNGoodJets_Zinc = newHisto("ZNGoodJets_Zinc","Jet Counter (incl.)", "N_{jets}", 11, -0.5, 10.5);
...
ZNGoodJets_Zinc->GetXaxis()->SetBinLabel(9,"N_{jets}  #geq 8");
ZNGoodJets_Zinc->GetXaxis()->SetBinLabel(10,"N_{jets} #geq 9");
ZNGoodJets_Zinc->GetXaxis()->SetBinLabel(11,"N_{jets} #geq 10");
...
TH1D *ptBal_Zexc2jet                = newHisto("ptBal_Zexc2jet",                "Vectorial pT sum: Z_{pT} + DiJet_{pT} (N_{jets} = 2)",                          "#Sigma pT [GeV]",      50,  0, 100);
TH1D *genptBal_Zexc2jet             = newHisto("genptBal_Zexc2jet",             "gen Vectorial pT sum: Z_{pT} + DiJet_{pT} (N_{jets} = 2)",                      "#Sigma pT [GeV]",      50,  0, 100);
...
TH1D *dEtaJets_Zexc2jet             = newHisto("dEtaJets_Zexc2jet",             "#Delta#eta btwn jets (N_{jets} = 2)",                                          jdEta,           50, 0, 6);
TH1D *gendEtaJets_Zexc2jet          = newHisto("gendEtaJets_Zexc2jet",          "gen #Delta#eta btwn jets (N_{jets} = 2)",                                      jdEta,           50, 0, 6);
TH1D *dEtaFirstJetZ_Zexc2jet        = newHisto("dEtaFirstJetZ_Zexc2jet",        "#Delta#eta btwn Jet_{1} and Z (N_{jets} = 2)",                                 "#Delta#eta(j_{1}Z)",           50, -6, 6);
TH1D *gendEtaFirstJetZ_Zexc2jet     = newHisto("gendEtaFirstJetZ_Zexc2jet",     "gen #Delta#eta btwn Jet_{1} and Z (N_{jets} = 2)",                             "#Delta#eta(j_{1}Z)",           50, -6, 6);
TH1D *dEtaSecondJetZ_Zexc2jet       = newHisto("dEtaSecondJetZ_Zexc2jet",       "#Delta#eta btwn Jet_{2} and Z (N_{jets} = 2)",                                 "#Delta#eta(j_{2}Z)",           50, -6, 6);
TH1D *gendEtaSecondJetZ_Zexc2jet    = newHisto("gendEtaSecondJetZ_Zexc2jet",    "gen #Delta#eta btwn Jet_{2} and Z (N_{jets} = 2)",                             "#Delta#eta(j_{2}Z)",           50, -6, 6);
TH1D *dEtaJet1Plus2Z_Zexc2jet       = newHisto("dEtaJet1Plus2Z_Zexc2jet",       "#Delta#eta btwn jets and Z (N_{jets} = 2)",                                    "#Delta#eta(j_{12}Z)",           50, -6, 6);
TH1D *gendEtaJet1Plus2Z_Zexc2jet    = newHisto("gendEtaJet1Plus2Z_Zexc2jet",    "gen #Delta#eta btwn jets and Z (N_{jets} = 2)",                                "#Delta#eta(j_{12}Z)",           50, -6, 6);
...
TH1D *ptBal_Zinc2jet                = newHisto("ptBal_Zinc2jet",                "Vectorial pT sum: Z_{pT} + DiJet_{pT} (N_{jets} #geq 2)",                       "#Sigma pT [GeV]",      50,  0, 100);
TH1D *genptBal_Zinc2jet             = newHisto("genptBal_Zinc2jet",             "gen Vectorial pT sum: Z_{pT} + DiJet_{pT} (N_{jets} #geq 2)",                   "#Sigma pT [GeV]",      50,  0, 100);
...
TH1D *dEtaJets_Zinc2jet             = newHisto("dEtaJets_Zinc2jet",             "#Delta#eta btwn jets (N_{jets} #geq 2)",                                       jdEta,           50, 0, 6);
TH1D *gendEtaJets_Zinc2jet          = newHisto("gendEtaJets_Zinc2jet",          "gen #Delta#eta btwn jets (N_{jets} #geq 2)",                                   jdEta,           50, 0, 6);
TH1D *dEtaFirstJetZ_Zinc2jet        = newHisto("dEtaFirstJetZ_Zinc2jet",        "#Delta#eta btwn Jet_{1} and Z (N_{jets} #geq 2)",                              "#Delta#eta(j_{1}Z)",           50, -6, 6);
TH1D *gendEtaFirstJetZ_Zinc2jet     = newHisto("gendEtaFirstJetZ_Zinc2jet",     "gen #Delta#eta btwn Jet_{1} and Z (N_{jets} #geq 2)",                          "#Delta#eta(j_{1}Z)",           50, -6, 6);
TH1D *dEtaSecondJetZ_Zinc2jet       = newHisto("dEtaSecondJetZ_Zinc2jet",       "#Delta#eta btwn Jet_{2} and Z (N_{jets} #geq 2)",                              "#Delta#eta(j_{2}Z)",           50, -6, 6);
TH1D *gendEtaSecondJetZ_Zinc2jet    = newHisto("gendEtaSecondJetZ_Zinc2jet",    "gen #Delta#eta btwn Jet_{2} and Z (N_{jets} #geq 2)",                          "#Delta#eta(j_{2}Z)",           50, -6, 6);
TH1D *dEtaJet1Plus2Z_Zinc2jet       = newHisto("dEtaJet1Plus2Z_Zinc2jet",       "#Delta#eta btwn jets and Z (N_{jets} #geq 2)",                                 "#Delta#eta(j_{12}Z)",           50, -6, 6);
TH1D *gendEtaJet1Plus2Z_Zinc2jet    = newHisto("gendEtaJet1Plus2Z_Zinc2jet",    "gen #Delta#eta btwn jets and Z (N_{jets} #geq 2)",                             "#Delta#eta(j_{12}Z)",           50, -6, 6);
...
TH1D *ptBal_LowPt_Zexc2jet          = newHisto("ptBal_LowPt_Zexc2jet",          "Vectorial pT sum: Z_{pT} + DiJet_{pT} at low Z_{pT} (N_{jets} = 2)",            "#Sigma pT [GeV]",      50, 0, 100);
TH1D *genptBal_LowPt_Zexc2jet       = newHisto("genptBal_LowPt_Zexc2jet",       "gen Vectorial pT sum: Z_{pT} + DiJet_{pT} at low Z_{pT} (N_{jets} = 2)",        "#Sigma pT [GeV]",      50, 0, 100);
...
TH1D *ptBal_LowPt_Zinc2jet          = newHisto("ptBal_LowPt_Zinc2jet",          "Vectorial pT sum: Z_{pT} + DiJet_{pT} at low Z_{pT} (N_{jets} #geq 2)",                        "#Sigma pT [GeV]",      50, 0, 100);
TH1D *genptBal_LowPt_Zinc2jet       = newHisto("genptBal_LowPt_Zinc2jet",       "gen Vectorial pT sum: Z_{pT} + DiJet_{pT} at low Z_{pT} (N_{jets} #geq 2)",                    "#Sigma pT [GeV]",      50, 0, 100);
...
//-- high Z pT
TH1D *ptBal_HighPt_Zexc2jet         = newHisto("ptBal_HighPt_Zexc2jet",         "Vectorial pT sum: Z_{pT} + DiJet_{pT} at high Z_{pT} (N_{jets} = 2)","#Sigma pT [GeV]",                 50,0.,100.);
TH1D *genptBal_HighPt_Zexc2jet      = newHisto("genptBal_HighPt_Zexc2jet",      "gen Vectorial pT sum: Z_{pT} + DiJet_{pT} at high Z_{pT} (N_{jets} = 2)","#Sigma pT [GeV]",             50,0.,100.);
...
TH1D *ptBal_HighPt_Zinc2jet         = newHisto("ptBal_HighPt_Zinc2jet",         "Vectorial pT sum: Z_{pT} + DiJet_{pT} at high Z_{pT} (N_{jets} #geq 2)","#Sigma pT [GeV]",                 50,0.,100.);
TH1D *genptBal_HighPt_Zinc2jet      = newHisto("genptBal_HighPt_Zinc2jet",      "gen Vectorial pT sum: Z_{pT} + DiJet_{pT} at high Z_{pT} (N_{jets} #geq 2)","#Sigma pT [GeV]",             50,0.,100.);
...
TH1D *NVtx = newHisto("NVtx","Number of vertices","#Vtx",45,0.5,45.5);
...
TH1D *jetsEta_JetsMatchGenJets = newHisto("jetsEta_JetsMatchGenJets","Jet Eta for matching jets","puMVA",48,-2.4,2.4);
TH1D *jetsEta_JetsNoMatchGenJets = newHisto("jetsEta_JetsNoMatchGenJets","Jet Eta for non matching jets","puMVA",48,-2.4,2.4);
...
TH1D *fullMET = newHisto("MET","MET for all passing leptons","MET for all passing leptons",200,0.,400.);
TH1D *fullMT  = newHisto("MT" ,"MT for all passing leptons" ,"MT for all passing leptons",200,0.,400.);
TH2D *METvslepIso =  new TH2D("MET vs lep Iso" ,"MET vs leptons Iso for all passing lepton",100,0.,300.,100, 0., 1 );
TH2D *MTvslepIso  =  new TH2D("MT vs lep Iso" ,"MT vs leptons Iso for all passing lepton",100,0.,300.,100, 0., 1 );


TH1D *MET_Zinc0jet                      = newHisto("MET_Zinc0jet",                      "MET (N_{jets} #geq 0)",  "MET [GeV]",      200,0.,400 );
TH1D *MET_Zinc1jet                      = newHisto("MET_Zinc1jet",                      "MET (N_{jets} #geq 1)",  "MET [GeV]",      200,0.,400 );
TH1D *MET_Zinc2jet                      = newHisto("MET_Zinc2jet",                      "MET (N_{jets} #geq 2)",  "MET [GeV]",      200,0.,400 );
TH1D *MET_Zinc3jet                      = newHisto("MET_Zinc3jet",                      "MET (N_{jets} #geq 3)",  "MET [GeV]",      200,0.,400 );

TH1D *METphi_Zinc0jet                      = newHisto("METphi_Zinc0jet",                      "MET #phi (N_{jets} #geq 0)",  "#phi(MET)",      100,-PI ,PI );
TH1D *METphi_Zinc1jet                      = newHisto("METphi_Zinc1jet",                      "MET #phi (N_{jets} #geq 1)",  "#phi(MET)",      100,-PI ,PI );
TH1D *METphi_Zinc2jet                      = newHisto("METphi_Zinc2jet",                      "MET #phi (N_{jets} #geq 2)",  "#phi(MET)",      100,-PI ,PI );
TH1D *METphi_Zinc3jet                      = newHisto("METphi_Zinc3jet",                      "MET #phi (N_{jets} #geq 3)",  "#phi(MET)",      100,-PI ,PI );

TH1D *MT_Zinc0jet                      = newHisto("MT_Zinc0jet",                      "MT (N_{jets} #geq 0)",    "MT [GeV]",    200,0.,400 );
TH1D *MT_Zinc1jet                      = newHisto("MT_Zinc1jet",                      "MT (N_{jets} #geq 1)",    "MT [GeV]",    200,0.,400 );
TH1D *MT_Zinc2jet                      = newHisto("MT_Zinc2jet",                      "MT (N_{jets} #geq 2)",    "MT [GeV]",    200,0.,400 );
TH1D *MT_Zinc3jet                      = newHisto("MT_Zinc3jet",                      "MT (N_{jets} #geq 3)",    "MT [GeV]",    200,0.,400 );
