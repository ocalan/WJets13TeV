{
    ...
    bool doSysRunning(0);
    int doWhat = 100; // 100 - all ; 0 - data, 1 - background , 2 - tau ???, 3 - DY, 4 - W+jets, 51 - MC gen, 90 - PDF Syst., 1001 - do pull DY samples
    ...
    short zzSyst[5]  = {0, 1, 1, 3, 3};
    short zzDir[5]   = {0,-1, 1,-1, 1};
    float zzScale[5] = {1, 1, 1, 0.06, 0.06};
        
    short wzSyst[5]  = {0, 1, 1, 3, 3};
    short wzDir[5]   = {0,-1, 1,-1, 1};
    float wzScale[5] = {1, 1, 1, 0.06, 0.06};
    
    short wwSyst[5]  = {0, 1, 1, 3, 3};
    short wwDir[5]   = {0,-1, 1,-1, 1};
    float wwScale[5] = {1, 1, 1, 0.08, 0.08};
        
    short tcsSyst[5]  = {0, 1, 1, 3, 3};
    short tcsDir[5]   = {0,-1, 1,-1, 1};
    float tcsScale[5] = {1, 1, 1, 0.06, 0.06};
    
    short tctSyst[5]  = {0, 1, 1, 3, 3};
    short tctDir[5]   = {0,-1, 1,-1, 1};
    float tctScale[5] = {1, 1, 1, 0.06, 0.06};
    
    short tcwSyst[5]  = {0, 1, 1, 3, 3};
    short tcwDir[5]   = {0,-1, 1,-1, 1};
    float tcwScale[5] = {1, 1, 1, 0.09, 0.09};
    ...
    if ( doWhat == 4 || doWhat == 100 ){
        ...
        if ( doSysRunning){
            ...
            else { // xsec offsets -- not done for SMu ---
