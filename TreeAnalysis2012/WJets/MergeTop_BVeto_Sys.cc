...
void runMergeTop_BVeto_Sys(string lepSelection = "DE", int systematics =0  , int jetPtCutMin = 30 , int doQCD = 0 );

void MergeTop_BVeto_Sys(){
    ...
    //runMergeTop_BVeto_Sys("SMu",0,30,0);
    runMergeTop_BVeto_Sys("SMu",1,30,0);
    runMergeTop_BVeto_Sys("SMu",-1,30,0);
    runMergeTop_BVeto_Sys("SMu",3,30,0);
    runMergeTop_BVeto_Sys("SMu",-3,30,0);
...
void runMergeTop_BVeto_Sys(string lepSelection, int systematics, int jetPtCutMin, int doQCD)
{
    TH1::SetDefaultSumw2();
    TH2::SetDefaultSumw2();
